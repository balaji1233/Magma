...
@dataclass
class DataCollatorForLlavaLlamaSupervisedDataset(object):
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:        
        input_ids, labels, pixel_values = \
            tuple([instance[key] for instance in instances] for key in ("input_ids", "labels", "pixel_values"))
        ...
        pixel_values_padded = pixel_values_padded.view(-1, pixel_values_padded.size(-3), pixel_values_padded.size(-2), pixel_values_padded.size(-1))
