...
class Howto100M(Constructor):
    def __init__(self, **kwargs):
        super(Howto100M, self).__init__(**kwargs)
        ...
        self.valid_verbs = self.settings['vocab']['verbs']
    ...
    def filter_items(self, items):
        ...
        """        
        filtered_items = []
        for item in tqdm(items, desc="Filtering items"):
            ...
            if (end_time-start_time) < 1:
                continue           
            if any(verb in global_instruction for verb in self.valid_verbs):           
