...
class MagmaDataProcessor(Trainer):
    ...
    def training_step(self, model, inputs):
        # Custom behavior before the step
        # print("Performing a custom training step...")        
    ...
    def _save_checkpoint(self, model, trial, metrics=None):
        if getattr(self.args, 'tune_mm_mlp_adapter', False):
            ...
            super(MagmaDataProcessor, self)._save_checkpoint(model, trial, metrics)

    def _save(self, output_dir: Optional[str] = None, state_dict=None):
        if getattr(self.args, 'tune_mm_mlp_adapter', False):
            pass
        else:
            super(MagmaDataProcessor, self)._save(output_dir, state_dict)
